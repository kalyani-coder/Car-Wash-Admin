...
const Master = () => {
  ...
  const handleWashTypeSubmit = async (event) => {
    ...
    try {
      const response = await fetch('http://localhost:5000/api/master/cars/washtype', {
        method: 'POST',
        headers: {
  ...
  //   event.preventDefault();
  //   try {
  //     const response = await fetch('http://localhost:5000/api/master/cars/vehicletype', {
  //       method: 'POST',
  //       headers: {
  //         'Content-Type': 'application/json'
  //       },
 ...
 const handlePaintProtectionTypeSubmit = async (event) => {
  event.preventDefault();
  try {
    const response = await fetch('http://localhost:5000/api/master/cars/paintprotection', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json'
      },
 ...
 const handleWindowFilmTypeSubmit = async (event) => {
  event.preventDefault();
  try {
    const response = await fetch('http://localhost:5000/api/master/cars/windowfilm', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json'
      },
...
const handleVinylWrapsTypeSubmit = async (event) => {
  event.preventDefault();
  try {
    const response = await fetch('http://localhost:5000/api/master/cars/vinalwraps', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json'
      },
...
const handlePremiumSeatTypeSubmit = async (event) => {
  event.preventDefault();
  try {
    const response = await fetch('http://localhost:5000/api/master/cars/premiumseat', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json'
      },
...
const handleLaminationTypeSubmit = async (event) => {
  event.preventDefault();
  try {
    const response = await fetch('http://localhost:5000/api/master/cars/lamination', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json'
      },
...
const handleInteriorTypeSubmit = async (event) => {
  event.preventDefault();
  try {
    const response = await fetch('http://localhost:5000/api/master/cars/interior', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json'
      },
  ...
  const handleCoatingTypeSubmit = async event => {
    event.preventDefault();
    try {
      const response = await fetch('http://localhost:5000/api/master/cars/coating', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json'
        },
