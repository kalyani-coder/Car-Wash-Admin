...
const UpdateMaster = () => {
  ...
  const handleSave = async () => {
    try {
      const response = await fetch(`http://localhost:5000/api/master/vehicletype/${selectedVehicle._id}`, {
        method: 'PATCH',
        headers: {
  ...
  useEffect(() => {
    fetch('http://localhost:5000/api/master/mainmaster')
 ...
 const handleEditWashType = () => {
  ...
  const handleDeleteWashType = async () => {
    ...
    try {
      const response = await fetch(`http://localhost:5000/api/master/washtype/${selectedWashType}`, {
        method: 'DELETE'
      });
      if (response.ok) {
  ...
  const handleDeleteCoatingType = async () => {
    ...
    try {
      const response = await fetch(`http://localhost:5000/api/master/coating/${selectedCoatingType}`, {
        method: 'DELETE'
      });
      if (response.ok) {
  ...
  const handleDeletePaintProtectionType = async () => {
    ...
    try {
      const response = await fetch(`http://localhost:5000/api/master/paintprotection/${selectedPaintProtectionType}`, {
        method: 'DELETE'
      });
      if (response.ok) {
  ...
  const handleDeleteWindowFilmType = async () => {
    ...
    try {
      const response = await fetch(`http://localhost:5000/api/master/windowfilm/${selectedWindowFilmType}`, {
        method: 'DELETE'
      });
      if (response.ok) {
  ...
  const handleDeleteVinylWrapsType = async () => {
    ...
    try {
      const response = await fetch(`http://localhost:5000/api/master/vinalwraps/${selectedVinylWrapsType}`, {
        method: 'DELETE'
      });
      if (response.ok) {
  ...
  const handleDeletePremiumSeatType = async () => {
    ...
    try {
      const response = await fetch(`http://localhost:5000/api/master/premiumseat/${selectedPremiumSeatType}`, {
        method: 'DELETE'
      });
      if (response.ok) {
  ...
  const handleDeleteLaminationType = async () => {
    ...
    try {
      const response = await fetch(`http://localhost:5000/api/master/lamination/${selectedLaminationType}`, {
        method: 'DELETE'
      });
      if (response.ok) {
  ...
  const handleDeleteInteriorType = async () => {
    ...
    try {
      const response = await fetch(`http://localhost:5000/api/master/interior/${selectedInteriorType}`, {
        method: 'DELETE'
      });
      if (response.ok) {
